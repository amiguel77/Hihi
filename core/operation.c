...
static unsigned int calculate_component_delay(
    ...
    if (component->size_kb < 16) {
        base += 20;
    } else if (component->size_kb < 128) {
        base += 35;
    } else if (component->size_kb < 512) {
        base += 55;
    } else if (component->size_kb < 2048) {
        base += 80;
    } else if (component->size_kb < 8192) {
        base += 120;
    } else {
        base += 180;
    }
...
static void process_component(
    ...
    operation->processed_kb +=
        component->size_kb;

    operation->current_size_kb =
        component->size_kb;
...
void operation_initialize(
    ...
    operation->current_size_kb = 0;
    operation->processed_kb = 0;
